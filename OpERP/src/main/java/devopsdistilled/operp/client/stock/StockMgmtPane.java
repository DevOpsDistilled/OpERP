...
public class StockMgmtPane extends TaskPane {
	...
	public JComponent getPane() {
		...
		iconListStock = new ImageIcon(
				StockMgmtPane.class.getResource("/client/icons/list.png"));
		...
		iconListWarehouse = new ImageIcon(
				StockMgmtPane.class.getResource("/client/icons/list2.png"));
		btnListWarehouse.setIcon(StandardButtonHelper
				.SetStandardSizeForImage(iconListWarehouse));
		pane.add(
				StandardButtonHelper.SetStandardSizeForButton(btnListWarehouse),
				"cell 0 2");
		...
		iconListStockActivities = new ImageIcon(
				StockMgmtPane.class.getResource("/client/icons/list3.png"));
