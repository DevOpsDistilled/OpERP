...
public final class ItemMgmtPane extends TaskPane {
	...
	@Override
	public Icon getIcon() {
		Icon icon=new ImageIcon(getClass().getResource("/client/icons/item_24.png"));
		return icon;
	}
	/**
	...
	public JComponent getPane() {
		...
		iconCreateProduct = new ImageIcon(ItemMgmtPane.class.
					getResource("/client/icons/Alerts.png"));
		btnCreateProduct.setIcon(StandardButtonHelper.SetStandardSizeForImage(iconCreateProduct));
		pane.add(StandardButtonHelper.SetStandardSizeForButton(btnCreateProduct), "cell 1 2");
		...
		btnCreateManufacturer = new JButton("<html>Create<br/> Manufacturer</html>");
		...
		btnListManufacturers = new JButton("<html>List<br/> Manufacturers</html>");
