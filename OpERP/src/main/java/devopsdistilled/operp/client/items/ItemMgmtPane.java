...
public final class ItemMgmtPane extends TaskPane {
	...
	public JComponent getPane() {
		...
		iconListItems = new ImageIcon(
				ItemMgmtPane.class.getResource("/client/icons/list2.png"));
		btnListItems.setIcon(StandardButtonHelper
				.SetStandardSizeForImage(iconListItems));
		pane.add(StandardButtonHelper.SetStandardSizeForButton(btnListItems),
				"cell 1 1");
		...
		iconlistCategories = new ImageIcon(
				ItemMgmtPane.class.getResource("/client/icons/list3.png"));
		...
		iconListProduct = new ImageIcon(
				ItemMgmtPane.class.getResource("/client/icons/list.png"));
		...
		iconListManufacturer = new ImageIcon(
				ItemMgmtPane.class.getResource("/client/icons/list.png"));
		btnListManufacturers.setIcon(StandardButtonHelper
				.SetStandardSizeForImage(iconListManufacturer));
		pane.add(StandardButtonHelper
				.SetStandardSizeForButton(btnListManufacturers), "cell 1 3");
