...
import devopsdistilled.operp.client.business.purchases.models.SaleDescModel;
...
public class SaleDescServiceImpl extends
		BusinessDescServiceImpl<SaleDesc, SaleDescRepository, SaleDescModel>
		implements SaleDescService {
